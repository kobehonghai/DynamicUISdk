...
import com.iqyi.paopao.dynamicuisdk.util.DecryptUtil;
import com.iqyi.paopao.dynamicuisdk.util.IOUtil;
import com.iqyi.paopao.dynamicuisdk.util.VerifyUtil;
import com.iqyi.paopao.dynamicuisdk.util.ZipUtil;
    ...
    public static InputStream loadEncryptScript(final Context context, final InputStream inputStream) {
        if (inputStream != null) {
            InputStream result = new ByteArrayInputStream(
                    ZipUtil.unzip(DecryptUtil.aes(context, IOUtil.toBytes(inputStream))));
            try {
                inputStream.close();
